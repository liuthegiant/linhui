...
def load_dataset(dataset='METRLA'):
    ...
    if dataset == 'METRLA':
        filename = '../METRLA/graph_sensor_locations_new.csv'
...
"""
def generate_quotient_graph(radius=0.01, dataset='data/graph_sensor_locations_new.csv'):
...
def generate_adjacency(mode):
    ...
    Q1, Q2 = generate_graphs(Q, nearest_node, clusters, gdf_nodes, gdf_edges, radius=0.01)
