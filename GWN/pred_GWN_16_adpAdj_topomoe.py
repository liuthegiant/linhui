...
def get_argv_topomoe():
    ...
    _apply_moe_run_tag(P, 'fcst')
    print('[TopoMoE forecast]', {k: getattr(P, k) for k in ['FUSION_MODE','MOE_EXPERTS','TOPO_LAP_K','MOE_TOP_K','MOE_TAU','MOE_LB_REG','MOE_SMOOTH_REG','MOE_DELTA_REG','MOE_USE_CTX','MOE_RUN_TAG']})
